...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6281377804838&text=Assalamualaikum')
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://indoxploit/hack-facebook/')
                time.sleep(2)
                menu()
